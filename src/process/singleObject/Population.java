...
//			System.out.println(individualCount);
	...
	public void updateMaxAndMin(Individual individual) {
		if (individual.getStep() < this.leastStep) {
			this.leastStep = individual.getStep();
		} else if (individual.getStep() > this.mostStep) {
			this.mostStep = individual.getStep();
		}

		if (individual.getDistance() < this.leastDistance) {
			this.leastDistance = individual.getDistance();
		} else if (individual.getDistance() > this.mostDistance) {
			this.mostDistance = individual.getDistance();
		}
	}
}